...
function ListCoupon() {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        couponservice
          ...
          .then((res) => {
            console.log(res);
            getAllCoupon(); // supression sans refresh
          })
          .catch((error) => {
            console.log(error);
          });
  ...
  const filteredData = coupon?.filter((el) => {
    if (inputText === "") {
      return el;
    } else {
                      ...
                      <table className="table app-table-hover mb-0 text-left">
                        <thead>
                          <tr>
                            ...
                            <th className="cell">UsageLimit</th>
                            <th className="cell">UsedCount</th>
                          ...
                          {filteredData?.map((item) => {
                            ...
                            return (
                              <tr id="trow_3">
                                ...
                                <td>
                                  <Link
                                    to={`/dashbord/updateCoupon/${item.id}`}
                                  >
