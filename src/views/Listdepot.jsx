    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        depotservice
          .remove(id)
          .then((res) => {
            getAllDepot(); // suppression sans refresh
          })
          .catch((error) => {
            console.log(error);
          });
                          ...
                          <table className="table app-table-hover mb-0 text-left">
                            <thead>
                              <tr>
                                ...
                                <th className="cell">Quantite Stock</th>
                              ...
                              {filteredData?.map((item) => {
                                return (
                                  <tr>
                                    ...
                                    <td className="cell">{item.articleId}</td>
                                    <td className="cell">
                                      <Link
                                        to={`/dashbord/updatedepot/${item.id}`}
                                      >
